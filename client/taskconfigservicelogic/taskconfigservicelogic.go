...
type (
	...
	TaskConfigServiceLogic interface {
		// 任务管理
	...
	defaultTaskConfigServiceLogic struct {
		cli zrpc.Client
	}
)

func NewTaskConfigServiceLogic(cli zrpc.Client) TaskConfigServiceLogic {
	return &defaultTaskConfigServiceLogic{
		cli: cli,
	}
}

// 任务管理
func (m *defaultTaskConfigServiceLogic) CreateTask(ctx context.Context, in *CreateTaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	client := storage.NewTaskConfigServiceLogicClient(m.cli.Conn())
	return client.CreateTask(ctx, in, opts...)
}

func (m *defaultTaskConfigServiceLogic) GetTask(ctx context.Context, in *GetTaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	client := storage.NewTaskConfigServiceLogicClient(m.cli.Conn())
	return client.GetTask(ctx, in, opts...)
}

func (m *defaultTaskConfigServiceLogic) UpdateTask(ctx context.Context, in *UpdateTaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
	client := storage.NewTaskConfigServiceLogicClient(m.cli.Conn())
	return client.UpdateTask(ctx, in, opts...)
}

func (m *defaultTaskConfigServiceLogic) DeleteTask(ctx context.Context, in *DeleteTaskRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	client := storage.NewTaskConfigServiceLogicClient(m.cli.Conn())
	return client.DeleteTask(ctx, in, opts...)
}

func (m *defaultTaskConfigServiceLogic) ListTasks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskListResponse, error) {
	client := storage.NewTaskConfigServiceLogicClient(m.cli.Conn())
