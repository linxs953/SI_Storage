...
type (
	...
	defaultTestDataService struct {
		cli zrpc.Client
	}
)

func NewTestDataService(cli zrpc.Client) TestDataService {
	return &defaultTestDataService{
		cli: cli,
	}
}

// 测试数据
func (m *defaultTestDataService) CreateTestData(ctx context.Context, in *CreateTestDataRequest, opts ...grpc.CallOption) (*TestDataResponse, error) {
	client := storage.NewTestDataServiceClient(m.cli.Conn())
	return client.CreateTestData(ctx, in, opts...)
}

func (m *defaultTestDataService) GetTestData(ctx context.Context, in *GetTestDataRequest, opts ...grpc.CallOption) (*TestDataResponse, error) {
	client := storage.NewTestDataServiceClient(m.cli.Conn())
	return client.GetTestData(ctx, in, opts...)
}

func (m *defaultTestDataService) UpdateTestData(ctx context.Context, in *UpdateTestDataRequest, opts ...grpc.CallOption) (*TestDataResponse, error) {
	client := storage.NewTestDataServiceClient(m.cli.Conn())
	return client.UpdateTestData(ctx, in, opts...)
}

func (m *defaultTestDataService) DeleteTestData(ctx context.Context, in *DeleteTestDataRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	client := storage.NewTestDataServiceClient(m.cli.Conn())
	return client.DeleteTestData(ctx, in, opts...)
}

func (m *defaultTestDataService) ListTestData(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TestDataListResponse, error) {
	client := storage.NewTestDataServiceClient(m.cli.Conn())
