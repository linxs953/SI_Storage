...
type (
	...
	SceneConfigServiceLogic interface {
		// 场景配置
	...
	defaultSceneConfigServiceLogic struct {
		cli zrpc.Client
	}
)

func NewSceneConfigServiceLogic(cli zrpc.Client) SceneConfigServiceLogic {
	return &defaultSceneConfigServiceLogic{
		cli: cli,
	}
}

// 场景配置
func (m *defaultSceneConfigServiceLogic) CreateSceneConfig(ctx context.Context, in *CreateSceneConfigRequest, opts ...grpc.CallOption) (*SceneConfigResponse, error) {
	client := storage.NewSceneConfigServiceLogicClient(m.cli.Conn())
	return client.CreateSceneConfig(ctx, in, opts...)
}

func (m *defaultSceneConfigServiceLogic) GetSceneConfig(ctx context.Context, in *GetSceneConfigRequest, opts ...grpc.CallOption) (*SceneConfigResponse, error) {
	client := storage.NewSceneConfigServiceLogicClient(m.cli.Conn())
	return client.GetSceneConfig(ctx, in, opts...)
}

func (m *defaultSceneConfigServiceLogic) UpdateSceneConfig(ctx context.Context, in *UpdateSceneConfigRequest, opts ...grpc.CallOption) (*SceneConfigResponse, error) {
	client := storage.NewSceneConfigServiceLogicClient(m.cli.Conn())
	return client.UpdateSceneConfig(ctx, in, opts...)
}

func (m *defaultSceneConfigServiceLogic) DeleteSceneConfig(ctx context.Context, in *DeleteSceneConfigRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	client := storage.NewSceneConfigServiceLogicClient(m.cli.Conn())
	return client.DeleteSceneConfig(ctx, in, opts...)
}

func (m *defaultSceneConfigServiceLogic) ListSceneConfigs(ctx context.Context, in *ListSceneConfigsRequest, opts ...grpc.CallOption) (*SceneConfigListResponse, error) {
	client := storage.NewSceneConfigServiceLogicClient(m.cli.Conn())
